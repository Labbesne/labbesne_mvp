...
to authenticate you. If you already generated keys that you already use with other services, you can skip this step.
...
&nbsp;&nbsp;&nbsp; :x: If you encountered an error, you will have to try again. Ask Abe, or preferrably StackOverflow.
...
Here's is a good default configuration for developing Ruby on Rails apps. Fork [this repo](https://github.com/Shalashtein/dotfiles) to make your own version of it.
